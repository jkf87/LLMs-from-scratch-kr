# GPT 기반 스팸 분류기와 상호작용하는 사용자 인터페이스 구축 (Building a User Interface to Interact With the GPT-based Spam Classifier)



이 보너스 폴더에는 아래와 같이 챕터 6의 미세조정된 GPT 기반 스팸 분류기와 상호작용하는 ChatGPT와 같은 사용자 인터페이스를 실행하는 코드가 포함되어 있습니다.
...
이 파일은 챕터 6에서 생성한 GPT-2 분류기 가중치를 로드하고 사용합니다. 이를 위해서는 먼저 [`../01_main-chapter-code/ch06.ipynb`](../01_main-chapter-code/ch06.ipynb) 파일을 실행해야 합니다.
